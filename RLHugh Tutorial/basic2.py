...
if __name__ == "__main__":
    ...
    for i in range(episodes):
        ...
        while not game.is_episode_finished():
            ...
            ### The code for making it learn
            # We can do reward per step but it could be really slow and it might not work
            # We're instead going to be doing reward per episode
            # His explination of why reward for episode is better is really good (ep 4 like 7 minutes in)
            # We want to calculate the loss for the whole episode but we do this mainly in the steps
